...
final List<GoRoute> routes = [
  GoRoute(
      path: "/",
      builder: (BuildContext context, GoRouterState state) => PlacesListPage(),
      routes: <GoRoute>[
        GoRoute(
            path: "permission",
            ...
            routes: <GoRoute>[
              GoRoute(
                  ...
                  builder: (BuildContext context, GoRouterState state) {
                    ...
                    final Function onTitleSave = params['onTitleSave'];
                    final String content = params['content'];
                    final Function onContentSave = params['onContentSave'];
