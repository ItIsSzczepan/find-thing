...
class RemovePlaceUseCase implements UseCase<bool, int> {
  final DatabaseRepository _databaseRepository;

  RemovePlaceUseCase(this._databaseRepository);

  @override
  Future<Either<Failure, bool>> call({required int params}) async {
    try {
      final bool result = await _databaseRepository.removePlace(params);
      return Right(result);
    } catch (e) {
